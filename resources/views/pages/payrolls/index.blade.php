...
@section('content')
    <div class="container mx-auto px-2 py-2 flex">
        <div class="w-2/5 py-2 space-y-2">
            <nav class="flex flex-col space-y-2 h-1/3">
                <div class="border-b border-b-gray-300 py-2">
                    <div class="sidebar-header items-center space-x-1">
                        <img src="/images/icons/add-square-svgrepo-com.svg" class="h-4">
                        <span>Add To</span> 
                    </div>
                </div>
                <div class="flex flex-col space-y-1">
                    <a href="" class="sidebar-sub-header space-x-1 items-center">
                        <img src="/images/icons/employee-svgrepo-com.svg" class="h-4">
                    ...
                    <a href="" class="sidebar-sub-header">S.S.S Premiums</a>
