<div class="w-1/4 py-2 space-y-2">
    <nav class="flex flex-col space-y-2 h-1/3 mr-6">
        ...
        <div class="flex flex-col space-y-1">
            ...
            class="{{ request()->is('premium') || request()->is('pag-ibig') || request()->is('phil-health') || request()->is('tax') ? 'sidebar-sub-header-active' : 'sidebar-sub-header space-x-1 items-center' }}">
